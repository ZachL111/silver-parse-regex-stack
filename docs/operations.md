...
`silver-parse-regex-stack` is centered on parsers work in Ruby. The technical target is: Implement a Ruby parsers project for regex simulation kernel, using seeded input scenarios and deterministic summary checks.
...
The score is deterministic. The current threshold is 159. Risk has a penalty of 4, latency has a penalty of 3, and weight contributes a bonus of 5.
