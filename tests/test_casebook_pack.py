"""Regression checks for the silver-parse-regex-stack casebook."""
...
from casebook.harness import assert_expected, silver_parse_regex_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(silver_parse_regex_stack_summary(), assert_expected())
